-- ================================================================================================
-- TITLE: Utility for finding root dir
-- ABOUT: Defines the utility function for finding root dir
-- ================================================================================================
...
function M.detectors.pattern(buf, patterns)
  ...
  return pattern and { M.norm(vim.fs.dirname(pattern)) } or {}
end
...
function M.setup()
  vim.api.nvim_create_user_command('LazyRoot', function()
    M.info()
  end, { desc = 'Project roots for the current buffer' })
